...
const languagesDatabase = {
  English: { label: "🌐 English", title: "🎯 My Daily Badges", task1: "🌞 Rise & Shine", task2: "📚 Brain Power", task3: "🥛 Strong Bones", story: "The Clever Fox. Once upon a time, a clever fox saw a crow with a piece of cheese. The fox praised the crow's voice, and when the crow opened its beak to sing, the cheese fell down, and the fox happily ate it.", appreciation: "Superstar!", langCode: 'en-US' },
  Hindi: { label: "🇮🇳 हिन्दी (Hindi)", title: "🎯 मेरे रोज़ के बैज", task1: "🌞 सुबह उठो", task2: "📚 होमवर्क", task3: "🥛 दूध का समय", story: "चतुर लोमड़ी की कहानी। एक बार एक लोमड़ी ने कौवे के पास पनीर देखा। उसने कौवे की मीठी आवाज़ की तारीफ की। जैसे ही कौवे ने गाने के लिए चोंच खोली, पनीर नीचे गिर गया और लोमड़ी उसे लेकर भाग गई।", appreciation: "आज आप सुपरस्टार!", langCode: 'hi-IN' },
  Vajjika: { label: "🇮🇳 बज्जिका (Vajjika)", title: "🎯 हम्मर रोज़ क बैज", task1: "🌞 सवेरे उठू", task2: "📚 दिमाग क कसरत", task3: "🥛 ताकतवर देह", story: "चतुर सियार क कहानी। एक बेर एक सियार कौआ के पास पनीर देखलक। ऊ कौआ के बोली के बड़ाई करलक। जैसे ही कौआ गावे लेल चोंच खोललक, पनीर नीचे गिर गेल आ सियार ओकरा लेके भाग गेल।", appreciation: "आज तूं कमाल क देलऽ!", langCode: 'hi-IN' },
  Maithili: { label: "🇮🇳 मैथिली (Maithili)", title: "🎯 हमर दैनिक बैज", task1: "🌞 भोर में उठू", task2: "📚 स्कूलक काज", task3: "🥛 पोषण", story: "चतुर लोमड़ीक कथा। एक बेर एकटा लोमड़ी कौआक पास पनीर देखलक। ऊ कौआक सुंदर आवाज़क प्रशंसा कएलक। जेना ही कौआ गाबay लेल चोंच खोललक, पनीर नीचा खसि पड़ल आ लोमड़ी ओकरा ल क भागि गेल।", appreciation: "बड्ड सुंदर काज!", langCode: 'hi-IN' },
  Bengali: { label: "🇮🇳 বাংলা (Bengali)", title: "🎯 আমার দৈনিক ব্যাজ", task1: "🌞 সকালের ম্যাজিক", task2: "📚 মগজ ধোলাই", task3: "🥛 শক্তিশালী হাড়", story: "চতুর শেয়ালের গল্প। এক সময় এক চতুর শেয়াল একটা কাকের মুখে পনিরের টুকরো দেখল। শেয়ালটি কাকের গানের গলার প্রশংসা করল। কাকটি গান গাওয়ার জন্য মুখ খুলতেই পনিরটি নিচে পড়ে গেল এবং শেয়ালটি তা খেয়ে নিল।", appreciation: "আজ তুমি সুপারস্টার!", langCode: 'bn-IN' },
  Tamil: { label: "🇮🇳 தமிழ் (Tamil)", title: "🎯 எனது தினசரி பேட்ஜ்கள்", task1: "🌞 காலை செயல்", task2: "📚 வீட்டுப்பாடம்", task3: "🥛 பால் நேரம்", story: "புத்திசாலி நரி ஒரு காகத்தை பார்த்தது. நரி காகத்தின் குரலை புகழ்ந்தது. காகம் பாடியதும் பாலாடைக்கட்டி கீழே விழுந்தது, நரி அதை சாப்பிட்டது.", appreciation: "சிறப்பான செயல்!", langCode: 'ta-IN' },
  Telugu: { label: "🇮🇳 తెలుగు (Telugu)", title: "🎯 నా రోజువారీ బ్యాడ్జ్‌లు", task1: "🌞 ఉదయం పని", task2: "📚 హోంవర్క్", task3: "🥛 పాలు తాగే సమయం", story: "ఒక నక్క కాకిని చూసింది. నక్క కాకి పాటను మెచ్చుకుంది. కాకి పాడటం మొదలుపెట్టగానే జున్ను కింద పడిపోయింది, నక్క దాన్ని తిన్నది.", appreciation: "సూపర్ స్టార్!", langCode: 'te-IN' },
  Marathi: { label: "🇮🇳 मराठी (Marathi)", title: "🎯 माझे दररोजचे बॅज", task1: "🌞 सकाळचे काम", task2: "📚 गृहपाठ", task3: "🥛 दुधाची वेळ", story: "हुशार कोल्ह्याने कावळ्याला पाहिले. कोल्ह्याने स्तुती केली. कावळ्याने गाणे गाताच तुकडा खाली पडला, कोल्ह्याने तो खाल्ला.", appreciation: "उत्तम काम!", langCode: 'mr-IN' },
  Gujarati: { label: "🇮🇳 ગુજરાતી (Gujarati)", title: "🎯 મારા રોજિંદા બેજ", task1: "🌞 સવારનું કામ", task2: "📚 હોમવર્ક", task3: "🥛 દૂધનો સમય", story: "ચાલાક શિયાળે કાગડાને જોયો. શિયાળે વખાણ કર્યા. કાગડાએ ગીત ગાયું કે ચીઝ નીચે પડી ગઈ, શિયાળે ખાઈ લીધી.", appreciation: "ખૂબ સરસ!", langCode: 'gu-IN' }
};
